...
(function() {
  this.Selection = (function() {
    var $bottom_overlay, $box, $cancel, $capture, $left_overlay, $retake, $right_overlay, $top_overlay, $trellosnap, append_confirmation_buttons, bind_confirmation_buttons, confirmation_buttons_html, disable_scroll, position_confirmation_buttons, resize_bottom_overlay, resize_right_overlay, resize_selection_box, resize_top_overlay, selection_box_html, win_w, win_y;
