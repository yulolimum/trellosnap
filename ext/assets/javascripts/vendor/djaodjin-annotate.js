...
(function($) {
  ...
  Annotate.prototype = {
    ...
    drawArrow: function(x, y, w, h, tint) {
      ...
      context.moveTo(w - 20 * Math.cos(angle + Math.PI / 15), h - 20 * Math.sin(angle + Math.PI / 15));
      context.lineTo(x + 2 * Math.cos(angle - Math.PI / 2), y + 2 * Math.sin(angle - Math.PI / 2));
      context.lineTo(x + 2 * Math.cos(angle + Math.PI / 2), y + 2 * Math.sin(angle + Math.PI / 2));
      context.lineTo(w - 20 * Math.cos(angle - Math.PI / 15), h - 20 * Math.sin(angle - Math.PI / 15));
      context.moveTo(w - 20 * Math.cos(angle - Math.PI / 7), h - 20 * Math.sin(angle - Math.PI / 7));
      context.lineTo(w, h);
      context.lineTo(w - 20 * Math.cos(angle + Math.PI / 7), h - 20 * Math.sin(angle + Math.PI / 7));
      context.lineTo(w - 20 * Math.cos(angle - Math.PI / 7), h - 20 * Math.sin(angle - Math.PI / 7));
      context.lineTo(w, h);
      context.strokeStyle = tint;
